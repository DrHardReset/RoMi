...
public class MidiIoComboboxControlViewModel : INotifyPropertyChanged
{
    ...
    public IMidiDeviceService MidiDeviceService => midiDeviceService;
    ...
    public MidiIoComboboxControlViewModel(INavigator navigator, MidiDocument midiDocument, IMidiDeviceService midiDeviceService)
    {
    ...
    public async Task SendSysexToDevice(bool isDt1)
    {
        ...
        catch (Exception ex)
        {
            ...
            _ = navigator.ShowMessageDialogAsync(this, title: "Sending MIDI message failed.", content: $"Sending MIDI message {SysExMessageDt1.ByteArrayToHexString()} to device failed.\n{ex}");
        }
    }
}
