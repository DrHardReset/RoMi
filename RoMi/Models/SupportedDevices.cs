...
public static class SupportedDevices
{
    public static ImmutableDictionary<string, string> Devices = ImmutableDictionary.CreateRange(
        new KeyValuePair<string, string>[] {
            ...
            KeyValuePair.Create("GAIA 2", "https://static.roland.com/assets/media/pdf/GAIA-2_MIDI_imple_eng01_W.pdf"),
            ...
            KeyValuePair.Create("JD-Xi", "https://static.roland.com/assets/media/pdf/JD-Xi_MIDI_Imple_e01_W.pdf"),
            ...
            KeyValuePair.Create("SPD-SX PRO", "https://static.roland.com/assets/media/pdf/SPD-SX_PRO_MIDI_Imple_eng01_W.pdf"),
    });
}
